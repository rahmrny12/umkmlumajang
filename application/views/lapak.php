				...
				<div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
					...
					<div class="header__account header__sticky--none">
						<ul class="d-flex">
							...
							<!--	<a class="header__account--btn" href="#hero">-->
							<!--		<span class="header__account--btn__text">Beranda</span>-->
							<!--	</a>-->
							<!--</li>-->
							<!--<li class="header__account--items">-->
							<!--	<a class="header__account--btn" href="#umkm">-->
							<!--		<span class="header__account--btn__text">Umkm</span>-->
							<!--	</a>-->
							<!--</li>-->
							<!--<li class="header__account--items">-->
							<!--	<a class="header__account--btn" href="#produk">-->
							<!--		<span class="header__account--btn__text">Produk</span>-->
							<!--	</a>-->
							<!--</li>-->
							<li class="header__account--items">
					...
					<div class="header__account header__account2 header__sticky--block">
						<ul class="d-flex">
							...
							<li class="header__account--items header__account2--items">
								<a class="header__account--btn minicart__open--btn" href="<?= base_url(); ?>admin/list_produk" data-offcanvas>
									<svg xmlns="http://www.w3.org/2000/svg" width="26.51" height="23.443" viewBox="0 0 14.706 13.534">
										<g transform="translate(0 0)">
											<g>
												<path data-name="Path 16787" d="M4.738,472.271h7.814a.434.434,0,0,0,.414-.328l1.723-6.316a.466.466,0,0,0-.071-.4.424.424,0,0,0-.344-.179H3.745L3.437,463.6a.435.435,0,0,0-.421-.353H.431a.451.451,0,0,0,0,.9h2.24c.054.257,1.474,6.946,1.555,7.33a1.36,1.36,0,0,0-.779,1.242,1.326,1.326,0,0,0,1.293,1.354h7.812a.452.452,0,0,0,0-.9H4.74a.451.451,0,0,1,0-.9Zm8.966-6.317-1.477,5.414H5.085l-1.149-5.414Z" transform="translate(0 -463.248)" fill="currentColor" />
												...
												<div class="product__items--content">
													...
													<ul class="product__items--action d-flex">
														<li class="product__items--action__list">
															<a class="product__items--action__btn add__to--cart" href="<?php echo base_url('user/pembayaran/') . $dk['id'] ?>">
...
<footer class="footer_section" style="background-color: black;">
							...
							<form action="#">
								...
								<div class="product__variant">
									...
									<div class="quickview__variant--list quantity d-flex align-items-center mb-15">
										...
										<a class="primary__btn quickview__cart--btn" href="<?= base_url(); ?>admin/transaksi">Add To Cart</a>
									</div>
	...
	<script>
		...
		// SEARCHING
		// $('#keyword-produk').on('keyup', function() {
		...
		//                                         <img style="height: 300px; object-fit: cover;" class="product__items--img product__primary--img" src="<?= base_url('assets/sb-admin/img/') ?>` + val.foto_barang + `" alt="product-img">
		//                                         <img style="height: 300px; object-fit: cover;" class="product__items--img product__secondary--img" src="<?= base_url('assets/sb-admin/img/') ?>` + val.foto_barang + `" alt="product-img">
		//                                     </a>
		//                                     <div class="product__badge">
		//                                         <span class="product__badge--items sale">Sale</span>
		//                                     </div>
		//                                 </div>
		//                                 <div class="product__items--content">
		//                                     <span class="product__items--content__subtitle">${val.nama_barang}</span>
		//                                     <div class="product__items--price">
		//                                         <span class="nama_barang">${val.harga}</span>
		//                                     </div>
		//                                     <ul class="product__items--action d-flex">
		//                                         <li class="product__items--action__list">
		...
		//                                                 data-nama-barang="${val.nama_barang}"
		//                                                 data-foto-barang="${val.foto_barang}"
		// 												data-galeri-1="${val.galeri[0]?.foto}"
		//                                                 data-galeri-2="${val.galeri[1]?.foto}"
		//                                             href="javascript:void(0)">
