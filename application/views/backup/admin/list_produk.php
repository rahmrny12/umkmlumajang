            ...
            <div class="offcanvas__inner">
                <div class="offcanvas__logo">
                    <a class="offcanvas__logo_link" href="index.html">
                        <img src="<?= base_url(); ?>assets/suruci/img/logo/nav-log.png" alt="Grocee Logo" width="158" height="36">
                    </a>
                        ...
                        <ul class="d-flex align-items-center">
                            <li class="language__currency--list">
                                <a class="offcanvas__language--switcher" href="#">
                                    <img class="language__switcher--icon__img" src="<?= base_url(); ?>assets/suruci/img/icon/language-icon.png" alt="currency">
                                    <span>English</span> 
                            ...
                            <li class="language__currency--list">
                                <a class="offcanvas__account--currency__menu" href="#">
                                    <img src="<?= base_url(); ?>assets/suruci/img/icon/usd-icon.png" alt="currency">
                                    <span>$ US Dollar</span> 
                                    <svg xmlns="http://www.w3.org/2000/svg" width="11.797" height="9.05" viewBox="0 0 9.797 6.05">
                                        <path  d="M14.646,8.59,10.9,12.329,7.151,8.59,6,9.741l4.9,4.9,4.9-4.9Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                    </svg>
                            ...
                            <table class="cart__table--inner">
                                ...
                                <tbody class="cart__table--body">
                                    <?php foreach ($keranjang as $data) : ?>
                                        ...
                                        <td class="cart__table--body__list">
                                            <div class="cart__product d-flex align-items-center">
                                                ...
                                                <div class="cart__thumbnail">
                                                    <a href="product-details.html"><img class="border-radius-5" src="<?= base_url('assets/sb-admin/img/') . $data['foto_barang']; ?>" 	alt="cart-product"></a>
                                                </div>
                                                <div class="cart__content">
                                                    <h4 class="cart__content--title"><a href="product-details.html"><?= $data['nama_barang'] ?></a></h4>
                                        ...
                                        <td class="cart__table--body__list">
                                            <span class="cart__price">Rp. <?= $data['harga'] ?></span>
                                        </td>
                            ...
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img" src="<?= base_url(); ?>assets/home/img/carousel-2.jpg" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="<?= base_url(); ?>assets/home/img/carousel-2.jpg" alt="product-img">
                                    </a>
