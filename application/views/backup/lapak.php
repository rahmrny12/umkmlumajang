...
<body>
			...
			<div class="container-fluid">
				<div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
					...
					<div class="main__logo">
						<h2 class="main__logo--title"><a class="main__logo--link" href="#">
						    LUMAJANG TULEN
						    <!--<img class="main__logo--img" src="<?= base_url(); ?>assets/home/lapak/suruchi/assets/img/logo/nav-log.png" alt="logo-img">-->
						    </a></h1>
					</div>
				...
				<div class="row row-cols-1">
					<div class="col">
						<div class="banner__section--inner position__relative">
							<a class="banner__items--thumbnail display-block" href="shop.html"><img class="banner__items--thumbnail__img banner__img--height__md display-block" src="<?= base_url(); ?>assets/suruci/img/lapak.jpeg" alt="banner-img">
							</a>
						</div>
					</div>
				</div>
								...
								<div class="col mb-30">
									<div class="product__items ">
										<div class="product__items--thumbnail">
											<a class="product__items--link" href="<?= base_url('assets/home/img/a.jpg'); ?>">
										...
										<div class="product__items--content">
											...
											<ul class="product__items--action d-flex">
												<li class="product__items--action__list">
													<a class="product__items--action__btn add__to--cart" href="<?= base_url()?>user/pembayaran">
												...
												?>
												<li class="product__items--action__list">
													<a class="product__items--action__btn" data-open="modal1" data-id-barang="<?= $dk['id_barang']; ?>" data-nama-barang="<?= $dk['nama_barang']; ?>" data-galeri-1="<?= isset($dk['galeri'][0]['foto']) ? htmlspecialchars($dk['galeri'][0]['foto']) : ''; ?>" data-galeri-2="<?= isset($dk['galeri'][1]['foto']) ? htmlspecialchars($dk['galeri'][1]['foto']) : ''; ?>" href="javascript:void(0)">
												...
												<li class="product__items--action__list">
													<a class="product__items--action__btn" target="_blank" data-open="modal1" href="https://maps.app.goo.gl/KszWT15641FgmTWp9">
												...
												<li class="product__items--action__list">
													<a target="_blank" class="product__items--action__btn" data-open="modal1" href="https://wa.me/+6285733063411?text=Halo!%20Saya%20tertarik%20dengan%20produk%20Anda">
								...
								<div class="swiper-wrapper">
									<div class="swiper-slide">
										<div class="product__media--preview__items">
											<a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href=""><img src="" class="foto_barang product__media--preview__items--img" alt="product-media-img"></a>
								...
								<div class="swiper-wrapper">
									<div class="swiper-slide">
										<div class="product__media--nav__items">
											<img class="galeri_1 product__media--nav__items--img" src="<?= base_url(); ?>assets/home/lapak/suruchi/assets/img/product/small-product7.png" alt="foto-produk">
										</div>
									</div>
									<div class="swiper-slide">
										<div class="product__media--nav__items">
											<img class="galeri_2 product__media--nav__items--img" src="<?= base_url(); ?>assets/home/lapak/suruchi/assets/img/product/small-product7.png" alt="foto-produk">
										</div>
									</div>
									<div class="swiper-slide">
										<div class="product__media--nav__items">
											<img class="galeri_3 product__media--nav__items--img" src="<?= base_url(); ?>assets/home/lapak/suruchi/assets/img/product/small-product7.png" alt="foto-produk">
										</div>
									</div>
									<div class="swiper-slide">
										<div class="product__media--nav__items">
											<img class="galeri_4 product__media--nav__items--img" src="<?= base_url(); ?>assets/home/lapak/suruchi/assets/img/product/small-product7.png" alt="foto-produk">
										</div>
									</div>
									<div class="swiper-slide">
										<div class="product__media--nav__items">
											<img class="galeri_5 product__media--nav__items--img" src="<?= base_url(); ?>assets/home/lapak/suruchi/assets/img/product/small-product7.png" alt="foto-produk">
										</div>
									</div>
								</div>
							...
							<form action="#">
								...
								<div class="product__variant">
									<div class="quickview__variant--list quantity d-flex align-items-center mb-15">
										...
										<a class="primary__btn quickview__cart--btn add-to-cart" href="#add-to-cart">Add To Cart</a>
									</div>
	...
	<script>
		$('.product__items--action__btn').on('click', function(event) {
			...
			$(".add-to-cart").data('id-barang', id_barang);
			$(".foto_barang").text(foto_barang);
			$(".foto_barang").attr('src', '<?= base_url('assets/sb-admin/img/') ?>' + foto_barang);
		...
		$('.add-to-cart').on('click', function(event) {
			var id_barang = $(this).data('id-barang');
			var kuantitas = $(this).siblings('.quantity__box').find('.quantity__number').val();
		...
		//     console.log(myVal)
		//     $(this).find(".nama_barang").text(myVal);
		// });
	</script>
